...
/**
 * Servlet implementation class RefusCandidatureRedirection
 */
@WebServlet("/RefusCandidature")
public class RefusCandidatureRedirection extends HttpServlet {
    ...
    public RefusCandidatureRedirection() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			entrepriseDao.repondreCandidature(codeEtd,codeStg,REFUS);
		...
		request.getRequestDispatcher("/WEB-INF/Vue/candidatures-validation-refus.jsp").forward(request, response);
	}
