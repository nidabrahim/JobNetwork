                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-pencil"></span> Experience Professionnelle</h3>
                                </div>
                                
                                <div class="col-md-12 col-xs-12" style="padding-top:20px;padding-bottom:20px">
                                            <a  style="width:20%;margin-left:78%" href="EtudiantAjoutExperienceProRedirection" class="btn btn-danger btn-block btn-rounded"  >Ajouter un poste</a>
                                 </div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <c:forEach items="${ListeExperiencePros }" var="expro" >
                                                ...
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong>${expro.employeur_experience_pro }</strong></td>
                                                    <td>${expro.fonction }</td>
                                                    <td>${expro.date_debut }</td>
                                                    <td>${expro.date_fin }</td>
                                                    <td>
