                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Ajouter</strong> Offre</h3>
                                    <ul class="panel-controls">
                                        <li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
                                    </ul>
                                </div>
                                <div class="panel-body">
                                    <p>Saisissez les informations generales de l'offre ainsi que ses criteres</p>
                                </div>
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Technologies requises</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <p></p>
                                            <span class="help-block"></span>
                                            <a  style="width:50%" href="#" class="btn btn-danger btn-block btn-rounded" data-toggle="modal" data-target="#ajouter_technologie">Ajouter</a>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Formation</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            
                                            <a  style="width:50%" href="#" class="btn btn-danger btn-block btn-rounded" data-toggle="modal" data-target="#ajouter_formation">Ajouter</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Langues</label>
                                        <div class="col-md-6 col-xs-12">                                    
                                        	<p  class="form-control " style="width:14%;float:left;margin-right:20px;border-color:white;background-color: white" >Anglais</p>
                                        	<label class="check" style="color:#3fbae4"> Obligatoire</label>
                                        	<br><br>  
