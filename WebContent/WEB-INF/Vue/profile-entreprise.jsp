                        ...
                        <div class="col-md-3 col-sm-4 col-xs-5">
                            ...
                            <div class="panel panel-default">                                
                                <div class="panel-body">
                                    <h3><span class="fa fa-user"></span> ${entrepriseSess.nom_entreprise }</h3>
                                    <p>${entrepriseSess.adresse_entreprise }</p>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${entrepriseSess.login_entreprise }</div> 
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7 view">
                                           <div class="view" >${entrepriseSess.nom_entreprise }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7 view">
                                          <div class="view" >${entrepriseSess.tel_fixe_entreprise }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Adresse</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${entrepriseSess.adresse_entreprise }</div> 
                                        </div>
                                    </div>                                          
                                    <div class="form-group">
