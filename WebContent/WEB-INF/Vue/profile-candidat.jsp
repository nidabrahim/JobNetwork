                        ...
                        <div class="col-md-3 col-sm-4 col-xs-5">
                            ...
                            <div class="panel panel-default">                                
                                <div class="panel-body">
                                    <h3><span class="fa fa-user"></span> ${candidat.nom_etudiant } ${candidat.prenom_etudiant }</h3>
                                    <p></p>
                                ...
                                <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">CP</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.code_postal }</div> 
                                           
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Ville</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.ville_etudiant }</div> 
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-group-separated">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.nom_etudiant }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Prenom</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.prenom_etudiant }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Date naissance</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.date_naissance_etudiant }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Adresse</label>
                                        <div class="col-md-9 col-xs-7 view">
                                            <div class="view" >${candidat.adresse_etudiant }</div> 
                                        </div>
                                    </div>                                          
                                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="panel panel-default form-horizontal">
                                ...
                                <div class="panel-body form-group-separated">                                    
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-xs-7 view">
                                            <div class="view" >${candidat.tel_gsm_etudiant }</div> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 col-xs-5 control-label">Tel Fixe</label>
                                        <div class="col-md-8 col-xs-7 view">
                                           <div class="view" >${candidat.tel_fixe_etudiant }</div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-4 col-xs-5 control-label">E-mail</label>
                                        <div class="col-md-8 col-xs-7 view">
                                            <div class="view" >${candidat.email_etudiant }</div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body form-horizontal form-group-separated">                                    
                                    <div class="form-group">
                                        <label class="col-md-6 col-xs-6 control-label">Francais</label>
                    ...
                    <div class="modal-body form-horizontal form-group-separated">                        
                        <div class="panel-body form-group-separated">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Formation</label>
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="Libelle formation" class="form-control"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label"></label>
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="Domaine" class="form-control" style="width:49%;float:left" />
                                            <input type="text" value="Type" class="form-control" style="width:49%;float:right" />
