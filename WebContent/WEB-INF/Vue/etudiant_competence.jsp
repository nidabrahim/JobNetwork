                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-pencil"></span> Competences</h3>
                                </div>
                                
                                <div class="col-md-12 col-xs-12" style="padding-top:20px;padding-bottom:20px">
                                            <a  style="width:20%;margin-left:78%" href="EtudiantAjoutCompetence" class="btn btn-danger btn-block btn-rounded" >Ajouter une competence</a>
                                 </div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <c:forEach items="${ListeCompetence }" var="competence" >
                                                ...
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong>${competence.logiciel.libele_logiciel }</strong></td>
                                                    <td><span class="label label-success">${competence.niv_logiciel.libele_logiciel }</span></td>
                                                    
                                                    <td>
                                                        <button class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></button>
                                                        <button class="btn btn-danger btn-rounded btn-condensed btn-sm" onClick="modal_change_photo"><span class="fa fa-times"></span></button>
                                                    </td>
                                                </tr>
