                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title"><span class="fa fa-pencil"></span> Formations</h3>
                                </div>
                                
                                <div class="col-md-12 col-xs-12" style="padding-top:20px;padding-bottom:20px">
                                            <a  style="width:20%;margin-left:78%" href="EtudiantFormation" class="btn btn-danger btn-block btn-rounded" >Ajouter une formation</a>
                                 </div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <c:forEach items="${ListeFormation }" var="formation" >
                                                ...
                                                <tr id="trow_1">
                                                    ...
                                                    <td><strong>${formation.libele_formation }</strong></td>
                                                    <td>${formation.type_formation }</td>
                                                    <td>${formation.domaine_formation }</td>
