        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb push-down-0">
                    ...
                    <li class="active">Lettre de motivation</li>
                </ul>
                <!-- END BREADCRUMB -->                
                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">
                        <div class="page-title">                    
                            <h2><span class="fa fa-pencil"></span> Lettre de motivation</h2>
                        </div>                         
                    ...
                    <div class="content-frame-body" style="margin-left: 0px" >
                        <div class="block">
                        <form role="form" class="form-horizontal" method="POST"  action="EnvoieCandidatureStage" >
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn btn-danger"><span class="fa fa-envelope"></span> Envoyer candidature</button>
                                    </div>                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                   ...
                                   <div class="col-md-6 col-xs-12">                                            
                                        <div class="input-group">
                                         ...
                                         <span class="help-block">Disponible a partir de cette date</span>
                                    </div>
                             </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">                            
                                    ...
                                    <textarea class="summernote_email" name="lettre" >                                     
                                    </textarea>                            
                                </div>
                            </div>
                            <div class="form-group">
