        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-cogs"></span> Informations generales</h2>
                </div>
                <!-- END PAGE TITLE -->                     
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">                        
                        ...
                        <div class="col-md-6 col-sm-8 col-xs-7">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <h3><span class="fa fa-pencil"></span> Informations personnelles </h3>
                                    <p></p>
                                </div>
                                <div class="panel-body form-group-separated">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="Nom" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-5 control-label">Prenom</label>
                                        <div class="col-md-9 col-xs-7">
                                            <input type="text" value="Prenom" class="form-control" disabled />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-xs-5">
                                            <button class="btn btn-primary btn-rounded pull-right">Valide</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
