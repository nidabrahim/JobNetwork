                    ...
                    <div class="content-frame-left">
                        ...
                        <div class="block">
                            <div class="list-group border-bottom">
                                <a href="#" class="list-group-item"><span class="fa fa-inbox"></span> Messages <span class="badge badge-success">${nbrpostul }</span></a>
                                ...
                                <a href="#" class="list-group-item"><span class="fa fa-rocket"></span> Refus <span class="badge badge-warning">${nbrpostulRefus }</span></a>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    ...
                                    <h3 class="panel-title">${postula.stage.entreprise.nom_entreprise } <small>${postula.stage.entreprise.email_entreprise }</small></h3>
                                </div>
                                
                            </div>
                            <div class="panel-body">
                                <h3>Acceptation <small class="pull-right text-muted"><span class="fa fa-clock-o"></span></small></h3>
                                ${postula.message}
